...
public class GlideBuilder {
    ...
    /**
     * Avisa o gerenciador para remover da memoria esta requisicao
     */
    private static void finalizeRequest(GlideImage glide){
        if(Mockup.getInstance().isDebug())
        Log.d("Glide","=> Liberando uma imagem da memoria");
        glide.free();
    }
}
